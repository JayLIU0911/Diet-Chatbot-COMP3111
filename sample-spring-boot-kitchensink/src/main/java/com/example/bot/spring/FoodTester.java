...
public class FoodTester {
	...
	@Test
	public void testSearchFoodFound()throws Exception{
		boolean thrown = false;
		ArrayList<ArrayList<String>> result = new ArrayList<ArrayList<String>>();
		try{
			result = food.searchFood("Chili chicken on rice");
		} catch (Exception e){
			thrown = true;
		}
	...
	//	boolean result = false;
		ArrayList<ArrayList<String>> result = new ArrayList<ArrayList<String>>();
		try{
			result = food.searchFood("Ironman");
			
		} catch (Exception e){
			thrown = true;
		}
		assertThat(!thrown).isEqualTo(true);
		assertThat(result.get(0).get(0)==null).isEqualTo(true);
	}
	...
	public void testfindOptimalMorefood()throws Exception{
		...
		foods.add("Chili chicken");
		foods.add("Banana");
		foods.add("Apple");
		foods.add("Beef beef beef beef beef");
		try{
	...
	public void testGetMenuInfo() throws Exception{
		...
		assertThat(result.contains("Food")).isEqualTo(true);
		assertThat(!thrown).isEqualTo(true);
	}
	...
	public void testWarningforSelectionGreater() throws Exception{
		...
		String result = null;
		try{
			result = this.food.WarningforFoodSelection("idealintaketest","beef beef beef");
		} catch (Exception e){
			thrown = true;
		}
	...
	public void testWarningforSelectionLess() throws Exception{
		...
		String result = null;
		try{
			result = this.food.WarningforFoodSelection("mrmuscle","ironman");
		} catch (Exception e){
			thrown = true;
		}
  ...
  public void testCreateMenuImageBad() throws Exception{
    boolean thrown = false;
    try{
        food.createMenuImage("Hero", "NotAValidUrl");
    }catch(Exception e){
        thrown = true;
    }
    assertThat(thrown).isEqualTo(true);
  ...
  public void testCreateMenuImageGood() throws Exception{
    boolean thrown = false;
    try{
        food.createMenuImage("Hero", "https://forum.bubble.is/uploads/default/original/3X/3/2/3203781e3319501fd56867f99daa8c6ed0461903.png");
    }catch(Exception e){
        thrown = true;
    }
    assertThat(!thrown).isEqualTo(true);
